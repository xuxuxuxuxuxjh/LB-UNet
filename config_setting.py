...
class setting_config:
    ...
    datasets = 'isic18' 
    if datasets == 'isic18':
        data_path = '/data1/xujiahao/Project/LB-UNet/data/isic2018/'
    elif datasets == 'isic17':
        data_path = '/data1/xujiahao/Project/LB-UNet/data/isic2017/'
    elif datasets == 'BUSI':
        data_path = '/data1/xujiahao/Project/LB-UNet/data/Dataset_BUSI_with_GT/'
    else:
